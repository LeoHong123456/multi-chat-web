...
public class DictController extends BaseController {
    ...
    @ResponseBody
    @PostMapping("/list")
    public JsonResult list(DictQuery query) {
        return dictService.getList(query);
    }
    ...
    @ResponseBody
    @PostMapping("/update")
    public JsonResult update(@RequestBody Dict entity) {
        return dictService.edit(entity);
    }
     ...
     * @return
     */
    @RequiresPermissions("sys:dict:dall")
